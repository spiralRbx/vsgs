...
local function BAGB_fake_script() -- Fake Script: StarterGui.ScreenGui.OpenButton.Abrir-MenuLocalScript
...
local function PBULZ_fake_script() -- Fake Script: StarterGui.ScreenGui.OpenButton.Arrasta-MenuLocalScript
    local script = Instance.new("LocalScript")
...
local function HFEOK_fake_script() -- Fake Script: StarterGui.ScreenGui.SPIFrame1.SPIFrameMenu.MainButton.LocalScript
    local script = Instance.new("LocalScript")
...
local function XJKKUQC_fake_script() -- Fake Script: StarterGui.ScreenGui.SPIFrame1.SPIFrameMenu.HatchButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function APZRDJ_fake_script() -- Fake Script: StarterGui.ScreenGui.SPIFrame1.SPIFrameMenu.SettingsButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function NUWFD_fake_script() -- Fake Script: StarterGui.ScreenGui.SPIFrame1.SPIFrameMenu.MainFrame.Main-ContainerFrame.ADAutoComboioButton.Espandimento-LocalScript
    local script = Instance.new("LocalScript")
...
local function OEFD_fake_script() -- Fake Script: StarterGui.ScreenGui.SPIFrame1.CloseButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function EYPE_fake_script() -- Fake Script: StarterGui.ScreenGui.SPIFrame1.Arrasta-FrameLocalScript
    local script = Instance.new("LocalScript")
...
coroutine.wrap(BAGB_fake_script)()
coroutine.wrap(PBULZ_fake_script)()
coroutine.wrap(HFEOK_fake_script)()
coroutine.wrap(XJKKUQC_fake_script)()
coroutine.wrap(APZRDJ_fake_script)()
coroutine.wrap(NUWFD_fake_script)()
coroutine.wrap(OEFD_fake_script)()
coroutine.wrap(EYPE_fake_script)()
